...
// Team screen: reverted to the original three-column version at the user's
// request. The tree-based rebuild remains on disk as TeamTree.tsx if wanted later.
        ...
        {activeTab === 'analytics' && (() => {
          ...
          return (
            <div className="page-enter">
              {/* Sub-tab bar */}
              <div className="bg-white/80 backdrop-blur-sm border-b border-slate-200/80 sticky top-[calc(56px+env(safe-area-inset-top,0px))] sm:top-[calc(60px+env(safe-area-inset-top,0px))] z-30 shadow-sm">
